...
rem %1:submitter name  %2: submitter email  %3: baseline %4: releaseTag %5:project
python %~d0\ltd\tools\booster\warning\findNewWarnings.py -m CI -d %~d0 -n %1 -e %2 -b %3 -t %4 -a N -prj %5
::pause&exit

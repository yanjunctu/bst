...
rem  %1: email  %2: baseline(last Dtag) %3: releaseTag(this Dtag) %4:project 
python %~d0\ltd\tools\booster\warning\findNewWarnings.py -m CI -d %~d0 -e %1 -b %2 -t %3 -a Y -prj %4
